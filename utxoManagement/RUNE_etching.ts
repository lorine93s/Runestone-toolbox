...
const getEtchingFee = async (script_p2tr: any, etching_redeem: any, etching_p2tr: any, name: any): Promise<number> => {
    let initialFee: any = 0;
    let redeemFee: number = 40000;
    ...
    do {
        ...
        console.log("ruen", psbt.data.outputs);
        const change = utxos[0].value - 546 - initialFee;

        psbt.addOutput({
            address: "tb1p55578npg8mx4w5zd7npud4c370d40yj42nhmjy0dy0hdmpar4vwqd6626w", // change address
            value: 546,
        });

        psbt.addOutput({
            address: "tb1pwacsky0kjs647xq4yan082zey3z4jves9q36ny846t4dwlrmntkqvjj9w0", // change address
            value: change,
        });
...
async function etching() {
    ...
    const etchingFee = getEtchingFee(script_p2tr, etching_redeem, etching_p2tr, name);
    const resolvedInscriptionFee: number = await etchingFee;
    console.log("etchingfee", resolvedInscriptionFee);
